...
public class NewsArticleRto {
	...
	public String toString() {
		return "NewsArticleRto [author=" + author + ", title=" + title + ", description=" + description + ", url=" + url
				+ ", urlToImage=" + urlToImage + ", publishedAt=" + publishedAt + ", username=" + username
				 + "]";
	}
	@Override
	public int hashCode() {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		NewsArticleRto other = (NewsArticleRto) obj;
		if (author == null) {
